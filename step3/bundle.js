...
var _ = __webpack_require__(0);
var Promise = __webpack_require__(1);
var localStorage = __webpack_require__(36);
...
var _ = __webpack_require__(0);
var cos = __webpack_require__(33);
var qiniu = __webpack_require__(34);
var s3 = __webpack_require__(35);
var AVError = __webpack_require__(3);
var AVRequest = __webpack_require__(2).request;
var Promise = __webpack_require__(1);
...
var parseBase64 = __webpack_require__(37);
...
var comments = ["Browser" || 'Node.js'].concat(__webpack_require__(31));
...
try {
  ...
  localStorage = __webpack_require__(43);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leancloud_storage__ = __webpack_require__(3);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
  ...
  methods: {
    ...
    login: function(){
        __WEBPACK_IMPORTED_MODULE_2_leancloud_storage___default.a.User.logIn('this.formData.username', 'this.formData.password').then((loginedUser) => {
          this.currentUser =  this.getCurrentUser();
        }, function (error) {
          alert('登录失败');
        });
    ...
    getCurrentUser: function(){
      let current = __WEBPACK_IMPORTED_MODULE_2_leancloud_storage___default.a.User.current();
      if(current) {
...
// module
exports.push([module.i, "#app .newTask {\n    width: 500px;\n    margin: 20px auto;\n}\n\n#app .newTask input {\n    width: 300px;\n    height: 30px;\n    line-height: 30px;\n    /*margin: 0 auto;*/\n    border: 1px solid #e5e5e5;\n    border-radius: 5px;\n    font-size: 14px;\n}\n#app .todos{\n    width: 380px;\n    margin-left: auto;\n    margin-right: auto;\n\n}\n#app .todos li {\n    max-width: 300px;\n    margin-bottom: 15px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n}\n#app .todos .btn-del {\n    width: 60px;\n    line-height: 18px;\n    padding: 5px;\n    float: right;\n    text-align: center;\n    background: #b63d32;\n    color: #fff;\n    margin-left: 20px;\n    border-radius: 5px;\n    border: none;\n}", ""]);
